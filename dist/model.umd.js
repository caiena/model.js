(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@caiena/lodash-ext'), require('@caiena/i18n'), require('validate.js'), require('moment')) :
  typeof define === 'function' && define.amd ? define(['exports', '@caiena/lodash-ext', '@caiena/i18n', 'validate.js', 'moment'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.model = {}, global._, global.i18n, global.validate, global.moment));
}(this, (function (exports, _, i18n, validate, moment) { 'use strict';
  ...
  var setGlobal$1 = function (key, value) {
    try {
      ...
      Object.defineProperty(global_1$1, key, { value: value, configurable: true, writable: true });
    } catch (error) {
  ...
  var f$b = descriptors$1 ? $getOwnPropertyDescriptor$1 : function getOwnPropertyDescriptor(O, P) {
  ...
  */
  ...
  // `Array.prototype.reduce` method
  // https://tc39.es/ecma262/#sec-array.prototype.reduce
  _export$1({ target: 'Array', proto: true, forced: !STRICT_METHOD$2 || CHROME_BUG }, {
  ...
  _export$1({ target: 'Date', proto: true, forced: FORCED$4 }, {
  ...
  _export$1({ target: 'String', proto: true, forced: !correctIsRegexpLogic('includes') }, {
    includes: function includes(searchString /* , position = 0 */) {
      return !!~toString_1(requireObjectCoercible$1(this))
  ...
  var FORCED$3 = !descriptors$1 || FAILS_ON_PRIMITIVES$5;
  ...
  var getOwnPropertyNames = objectGetOwnPropertyNamesExternal$1.f;

  // eslint-disable-next-line es/no-object-getownpropertynames -- required for testing
  var FAILS_ON_PRIMITIVES$3 = fails$1(function () { return !Object.getOwnPropertyNames(1); });
  ...
  function writableProp(instance, name) {
    ...
    if (___default['default'].includes(['constructor'], name) || ___default['default'].startsWith(name, '$')) return false;
  ...
  function writablePropNames(instance) {
    var prototype = Object.getPrototypeOf(instance);
    var propNames = ___default['default'].chain(Object.getOwnPropertyNames(instance)).
    concat(Object.getOwnPropertyNames(prototype)).
    uniq().
    value().
    sort();

    return ___default['default'].filter(propNames, function (name) {return writableProp(instance, name);});
  }
  ...
  var document$1$1 = global_1.document;
  // typeof document.createElement is 'object' in old IE
  var EXISTS = isObject(document$1$1) && isObject(document$1$1.createElement);
  ...
  */
  ...
  var onFreeze = function (it) {
    if (freezing$1 && REQUIRED && isExtensible(it) && !has$1(it, METADATA)) setMetadata(it);
    return it;
  };
  ...
  var onFreeze$1 = internalMetadata$1.onFreeze;

  // eslint-disable-next-line es/no-object-freeze -- safe
  var $freeze$1 = Object.freeze;
  var FAILS_ON_PRIMITIVES$1 = fails(function () { $freeze$1(1); });

  // `Object.freeze` method
  // https://tc39.es/ecma262/#sec-object.freeze
  _export({ target: 'Object', stat: true, forced: FAILS_ON_PRIMITIVES$1, sham: !freezing$1 }, {
    freeze: function freeze(it) {
      return $freeze$1 && isObject(it) ? $freeze$1(onFreeze$1(it)) : it;
    }
  });
  ...
  var ITERATOR$2$1 = wellKnownSymbol('iterator');
  var BUGGY_SAFARI_ITERATORS$1$1 = false;

  var returnThis$2$1 = function () { return this; };
  ...
  if ([].keys) {
    ...
    if (!('next' in arrayIterator$1)) BUGGY_SAFARI_ITERATORS$1$1 = true;
      ...
      PrototypeOfArrayIteratorPrototype$1 = objectGetPrototypeOf(objectGetPrototypeOf(arrayIterator$1));
      if (PrototypeOfArrayIteratorPrototype$1 !== Object.prototype) IteratorPrototype$2$1 = PrototypeOfArrayIteratorPrototype$1;
    }
  }

  var NEW_ITERATOR_PROTOTYPE$1 = IteratorPrototype$2$1 == undefined || fails(function () {
    var test = {};
    // FF44- legacy iterators case
    return IteratorPrototype$2$1[ITERATOR$2$1].call(test) !== test;
  });
  ...
  if (!has$1(IteratorPrototype$2$1, ITERATOR$2$1)) {
    createNonEnumerableProperty(IteratorPrototype$2$1, ITERATOR$2$1, returnThis$2$1);
  }
  ...
  var TO_STRING_TAG$3$1 = wellKnownSymbol('toStringTag');

  var setToStringTag$1 = function (it, TAG, STATIC) {
    if (it && !has$1(it = STATIC ? it : it.prototype, TO_STRING_TAG$3$1)) {
      defineProperty$1(it, TO_STRING_TAG$3$1, { configurable: true, value: TAG });
    }
  };
  ...
  var createIteratorConstructor$1 = function (IteratorConstructor, NAME, next) {
    ...
    IteratorConstructor.prototype = objectCreate(IteratorPrototype$1$1, { next: createPropertyDescriptor(1, next) });
  ...
  var ITERATOR$1$1 = wellKnownSymbol('iterator');
  var KEYS$1 = 'keys';
  var VALUES$1 = 'values';
  ...
  var defineIterator$1 = function (Iterable, NAME, IteratorConstructor, next, DEFAULT, IS_SET, FORCED) {
    ...
    var nativeIterator = IterablePrototype[ITERATOR$1$1]
    ...
    if (anyNativeIterator) {
      ...
      if (IteratorPrototype$3 !== Object.prototype && CurrentIteratorPrototype.next) {
        if (objectGetPrototypeOf(CurrentIteratorPrototype) !== IteratorPrototype$3) {
          ...
          } else if (typeof CurrentIteratorPrototype[ITERATOR$1$1] != 'function') {
            createNonEnumerableProperty(CurrentIteratorPrototype, ITERATOR$1$1, returnThis$3);
          }
        }
    ...
    // define iterator
    if (IterablePrototype[ITERATOR$1$1] !== defaultIterator) {
      createNonEnumerableProperty(IterablePrototype, ITERATOR$1$1, defaultIterator);
    }
    ...
    if (DEFAULT) {
      ...
      } else _export({ target: NAME, proto: true, forced: BUGGY_SAFARI_ITERATORS$2 || INCORRECT_VALUES_NAME }, methods);
    }
  ...
  var TO_STRING_TAG$2$1 = wellKnownSymbol('toStringTag');
  var test$1 = {};
  ...
  var TO_STRING_TAG$1$1 = wellKnownSymbol('toStringTag');
  // ES3 wrong here
  ...
  var classof$1 = toStringTagSupport$1 ? classofRaw : function (it) {
    ...
    return it === undefined ? 'Undefined' : it === null ? 'Null'
      // @@toStringTag case
      : typeof (tag = tryGet$1(O = Object(it), TO_STRING_TAG$1$1)) == 'string' ? tag
      // builtinTag case
  ...
  for (var COLLECTION_NAME$2 in domIterables$1) {
    ...
    if (CollectionPrototype$2) {
      ...
      if (CollectionPrototype$2[ITERATOR$6] !== ArrayValues$1) try {
        createNonEnumerableProperty(CollectionPrototype$2, ITERATOR$6, ArrayValues$1);
      } catch (error) {
        CollectionPrototype$2[ITERATOR$6] = ArrayValues$1;
      }
      if (!CollectionPrototype$2[TO_STRING_TAG$4]) {
        createNonEnumerableProperty(CollectionPrototype$2, TO_STRING_TAG$4, COLLECTION_NAME$2);
      }
  ...
  function Attributable(Class) {var
    ...
    AttributableClass = /*#__PURE__*/function (_Class) {_inherits(AttributableClass, _Class);var _super = _createSuper(AttributableClass);
      ...
      function AttributableClass() {var _this;_classCallCheck$1(this, AttributableClass);for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {args[_key] = arguments[_key];}
        ...
        ___default['default'].each(klass.$enums, function (enumeration, enumName) {
          // sanity check!
          // enum must be defined in attrs list as well
          if (!___default['default'].includes(klass.$attrs, enumName)) {
        ...
        ___default['default'].each(klass.$attrs, function (attrName) {
          // XXX: lodash _.has and _.hasIn actually _execute_ the method/property to check for
          // existence. We don't want that!
      ...
      }_createClass$1(AttributableClass, [{ key: "$attrs", get:
        ...
        function set(attrs) {var _this2 = this;
          ...
          var sanitizedAttrs = ___default['default'].pick(attrs, this.constructor.$attrs);
          ___default['default'].each(sanitizedAttrs, function (value, name) {
            _this2[name] = value;
          });
        }
        ...
        // TODO: remove it?
          ...
          var propNames = ___default['default'].chain(Object.getOwnPropertyNames(proto)).
          concat(Object.getOwnPropertyNames(instance)).
          filter(function (name) {return !(___default['default'].includes(['constructor'], name) || ___default['default'].startsWith(name, '$'));}).
          uniq().
          value().
          sort();

          return ___default['default'].reduce(propNames, function (props, propName) {
        ...
        function $blank(attrNameOrPath) {
          return ___default['default'].blank(this.$get(attrNameOrPath));
        } }, { key: "$enumValue", value:
        ...
        function $get(attrNameOrPath) {
          return ___default['default'].get(this, attrNameOrPath);
        } }, { key: "$has", value:
        ...
        function $has(attrNameOrPath) {
          ...
          return ___default['default'].has(this, attrNameOrPath);
        } }, { key: "$pick", value:
        ...
        function $pick() {for (var _len2 = arguments.length, attrNamesOrPathes = new Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {attrNamesOrPathes[_key2] = arguments[_key2];}
          return ___default['default'].pick.apply(___default['default'], [this].concat(attrNamesOrPathes));
        } }, { key: "$present", value:

        function $present(attrNameOrPath) {
          return ___default['default'].present(this.$get(attrNameOrPath));
        } }, { key: "$set", value:

        function $set(attrNameOrPath, value) {
          return ___default['default'].set(this, attrNameOrPath, value);
        ...
        function get() {// avoiding static property inheritance
          ...
          if (!this.hasOwnProperty('$$enums')) {this.$$enums = ___default['default'].reduce(this.enums, function (result, enumeration, enumName) {// transform to Enum instance, if needed
        ...
        // TODO: define types and create "intelligent" setters? (with constraints)
          ...
          // @see http://thecodebarbarian.com/static-properties-in-javascript-with-inheritance.html
          if (!this.hasOwnProperty('$$attrs')) {this.$$attrs = ___default['default'].clone(this.attrs);}return this.$$attrs;} // lazy evaluated $virtuals
        // for now we're only keeping the API consistent, adding a '$methodName' getter
        // TODO: define types and create "intelligent" setters? (with constraints)
      }, { key: "$virtuals", get: function get() {// avoiding static property inheritance
          // @see http://thecodebarbarian.com/static-properties-in-javascript-with-inheritance.html
          if (!this.hasOwnProperty('$$virtuals')) {this.$$virtuals = ___default['default'].clone(this.virtuals);}return this.$$virtuals;} }]);return AttributableClass;}(Class);return AttributableClass;}
  ...
  function belongsTo(instance, relationName, config) {var _ref = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {},_ref$get = _ref.get,get = _ref$get === void 0 ? null : _ref$get,_ref$set = _ref.set,set = _ref$set === void 0 ? null : _ref$set;
    ...
    if (!set) {
      ...
      set = function set(value) {
        ...
        if (___default['default'].isArray(value)) throw new Error("can't assign an array to a belongsTo relation");
  ...
  function hasOne(instance, relationName, config) {var _ref2 = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {},_ref2$get = _ref2.get,get = _ref2$get === void 0 ? null : _ref2$get,_ref2$set = _ref2.set,set = _ref2$set === void 0 ? null : _ref2$set;
    ...
    if (!set) {
      ...
      set = function set(value) {
        ...
        if (___default['default'].isArray(value)) throw new Error("can't assign an array to a hasOne relation");
  ...
  function hasMany(instance, relationName, config) {var _ref3 = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {},_ref3$get = _ref3.get,get = _ref3$get === void 0 ? null : _ref3$get,_ref3$set = _ref3.set,set = _ref3$set === void 0 ? null : _ref3$set;
    ...
    if (!set) {
      ...
      set = function set(values) {
        ...
        if (!___default['default'].isArray(values)) throw new Error("can't assign a non-array value to a hasMany relation");

        // TODO: should we assign values to fks? `${relation}_id`

        var modelInstances = ___default['default'].map(values, function (value) {
  ...
  function Relatable(Class) {var
    ...
    RelatableClass = /*#__PURE__*/function (_Class) {_inherits(RelatableClass, _Class);var _super = _createSuper(RelatableClass);
      ...
      function RelatableClass() {var _this;_classCallCheck$1(this, RelatableClass);for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {args[_key] = arguments[_key];}
        _this = _super.call.apply(_super, [this].concat(args));
        ...
        ___default['default'].each(klass.relations, function (config, relationName) {
          // XXX: lodash _.has and _.hasIn actually _execute_ the method/property to check for
          // existence. We don't want that!
      ...
      }_createClass$1(RelatableClass, [{ key: "$relations", get:
        ...
        function get() {// avoiding static property inheritance
          // @see http://thecodebarbarian.com/static-properties-in-javascript-with-inheritance.html
          if (!this.hasOwnProperty('$$relations')) {this.$$relations = this.$$relations || ___default['default'].reduce(this.relations, function (result, config, name) {result[name] = config;return result;}, {});}return this.$$relations;} }]);return RelatableClass;}(Class);return RelatableClass;
  }

  function Translatable(Class) {var
    TranslatableClass = /*#__PURE__*/function (_Class) {_inherits(TranslatableClass, _Class);var _super = _createSuper(TranslatableClass);function TranslatableClass() {_classCallCheck$1(this, TranslatableClass);return _super.apply(this, arguments);}_createClass$1(TranslatableClass, null, [{ key: "i18nScope", get:
        function get() {
        ...
        function $tAttr(attrName) {var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
          ...
          return i18n.i18n.t(attrName, ___default['default'].defaults({}, options, { scope: scope }));
        } }, { key: "$tEnum", value:
        ...
        function $tEnum(enumName) {var enumValue = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : undefined;var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
          ...
          return i18n.i18n.t(key, ___default['default'].defaults({}, options, { scope: scope }));
        }
  ...
  var speciesConstructor = function (O, defaultConstructor) {
    ...
    var S;
    return C === undefined || (S = anObject$1(C)[SPECIES$1]) == undefined ? defaultConstructor : aFunction$1(S);
  };

  var engineIsIos = /(?:ipad|iphone|ipod).*applewebkit/i.test(engineUserAgent$1);

  var set = global_1$1.setImmediate;
  ...
  var post = function (id) {
    ...
    global_1$1.postMessage(String(id), location.protocol + '//' + location.host);
  };
  ...
  var engineIsIosPebble = /ipad|iphone|ipod/i.test(engineUserAgent$1) && global_1$1.Pebble !== undefined;
  ...
  var queueMicrotaskDescriptor = getOwnPropertyDescriptor(global_1$1, 'queueMicrotask');
  ...
  var DISPATCH_EVENT = !!(document$1 && document$1.createEvent && global_1$1.dispatchEvent);
  ...
  for (var COLLECTION_NAME$1 in domIterables) {
    ...
    if (CollectionPrototype$1 && CollectionPrototype$1.forEach !== arrayForEach) try {
      createNonEnumerableProperty$1(CollectionPrototype$1, 'forEach', arrayForEach);
    } catch (error) {
  ...
  validate__default['default'].extend(validate__default['default'].validators.datetime, {
    ...
    parse: function parse(value, options) {
      ...
      return moment__default['default'].utc(value);
    },
    // Input is a unix timestamp
    format: function format(value, options) {
      var format = options.dateOnly ? 'YYYY-MM-DD' : 'YYYY-MM-DD hh:mm:ss';
      return moment__default['default'].utc(value).format(format);
    } });



  validate__default['default'].validators.datetime;

  // XXX overwriting presence validator.
  //
  function presence(value, options, key, attrs) {
    var opts = ___default['default'].merge({}, this.options, options);

    if (___default['default'].blank(value)) {
  ...
  validate__default['default'].validators.presence = presence;
  ...
  function transformErrors(i18nScope, errors) {
    ...
    //   }
    // ]
    errors = validate__default['default'].groupErrorsByAttribute(errors);
    ...
    for (var attr in errors) {
      ...
      errors[attr]),_step;try {for (_iterator.s(); !(_step = _iterator.n()).done;) {var error = _step.value;
          ...
          var message = ___default['default'].get(error, 'options.message') ||
  ...
  function _validate(instance) {
    ...
    return new Promise(function (resolve, reject) {
      ...
      validate__default['default'].async(instance, constraints, { format: 'detailed', cleanAttributes: false }).
      then(
  ...
  function Validatable(Class) {var
    ...
    ValidatableClass = /*#__PURE__*/function (_Class) {_inherits(ValidatableClass, _Class);var _super = _createSuper(ValidatableClass);
      ...
      function ValidatableClass() {var _this;_classCallCheck$1(this, ValidatableClass);for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {args[_key] = arguments[_key];}
        _this = _super.call.apply(_super, [this].concat(args));
        defineInternalProp(_assertThisInitialized(_this), '$$errors', {});return _this;
      }_createClass$1(ValidatableClass, [{ key: "$errors", get:
        ...
        function get() {
          ...
          function _callee() {var _ref,_ref$relations,relations,instance,promises,relationNames,_relations,responses,hasError,_args = arguments;return regeneratorRuntime.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_ref = _args.length > 0 && _args[0] !== undefined ? _args[0] : {}, _ref$relations = _ref.relations, relations = _ref$relations === void 0 ? false : _ref$relations;
                    ...
                    if (relations) {
                      ...
                      _relations = ___default['default'].pickBy(instance, function (relationData, relationName) {
                        return relationNames.includes(relationName) && ___default['default'].present(relationData);
                      });

                      ___default['default'].each(_relations, function (relationData, _relationName) {
          ...
          // @see http://thecodebarbarian.com/static-properties-in-javascript-with-inheritance.html
          if (!this.hasOwnProperty('$$constraints')) {this.$$constraints = ___default['default'].clone(this.constraints);}return this.$$constraints;} }]);return ValidatableClass;}(Class);
  ...
  function _serializeObject(obj) {
    return ___default['default'].reduce(obj, function (serialized, value, key) {
  ...
  function _serialize(value) {
    ...
    if (___default['default'].isObjectLike(value)) {
  ...
  Base = /*#__PURE__*/function () {function Base() {_classCallCheck$1(this, Base);}_createClass$1(Base, null, [{ key: "$modelNameAdapter", get:
      function get() {return ___default['default'].camelize;} }, { key: "$modelName", get:
    ...
    function Model() {var _this2, _this3;var _this;var props = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},_ref$undefs = _ref.undefs,undefs = _ref$undefs === void 0 ? true : _ref$undefs;_classCallCheck$1(this, Model);
      ...
      var sanitizedProps = ___default['default'].pick(props, propNames);

      if (undefs) {
        // start all props with undefined, allowing them to be observed (rxjs, Vue, ...)
        var undefProps = ___default['default'].reduce(propNames, function (undefProps, name) {
        ...
        sanitizedProps = ___default['default'].merge(undefProps, sanitizedProps);
      }

      // set props, one-by-one, using setter method
      ___default['default'].each(sanitizedProps, function (value, name) {
        _this[name] = value;
      });

      (_this3 = _this).$afterInit.apply(_this3, arguments); // hook for user land
      return _this;}_createClass$1(Model, [{ key: "$beforeInit", value:
      ...
      function toJSON() {var _ref2 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},_ref2$pick = _ref2.pick,pick = _ref2$pick === void 0 ? [] : _ref2$pick,_ref2$include = _ref2.include,include = _ref2$include === void 0 ? [] : _ref2$include,_ref2$omit = _ref2.omit,omit = _ref2$omit === void 0 ? [] : _ref2$omit,_ref2$virtuals = _ref2.virtuals,virtuals = _ref2$virtuals === void 0 ? false : _ref2$virtuals,_ref2$relations = _ref2.relations,relations = _ref2$relations === void 0 ? false : _ref2$relations,_ref2$undefs = _ref2.undefs,undefs = _ref2$undefs === void 0 ? false : _ref2$undefs;
        var json = ___default['default'].clone(this.$attrs);


        if (virtuals) {
          ___default['default'].merge(json, ___default['default'].pick(this, this.constructor.virtuals));
        }

        if (relations) {
          var modelRelations = Object.keys(this.$relations);
          ___default['default'].merge(json, ___default['default'].pick(this, modelRelations));
        }

        if (___default['default'].present(pick)) {
          json = ___default['default'].pick(json, pick);
        }

        if (___default['default'].present(include)) {
          json = ___default['default'].merge(json, ___default['default'].pick(this, include));
        }

        if (___default['default'].present(omit)) {
          json = ___default['default'].omit(json, omit);
        }

        if (!undefs) {
          json = ___default['default'].pickBy(json, function (val, key) {return !___default['default'].isUndefined(val);});
        }

        json = ___default['default'].reduce(json, function (serialized, value, propName) {
  ...
  function Decorator(ModelClass) {var
    ...
    DecoratedClass = /*#__PURE__*/function (_ModelClass) {_inherits(DecoratedClass, _ModelClass);var _super = _createSuper(DecoratedClass);
      ...
      function DecoratedClass(object) {_classCallCheck$1(this, DecoratedClass);
      ...
      _createClass$1(DecoratedClass, [{ key: "$beforeInit", value: function $beforeInit(props, opts) {
  ...
  ___default['default'].each(contents, function (content, _id) {
    ___default['default'].merge(translations, content);
  });
