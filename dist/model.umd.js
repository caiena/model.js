(function (global, factory) {
  ...
  function deepCamelizeKeys(object) {
    var camelized = lodash.cloneDeep(object);

    lodash.forOwn(object, function (value, key) {
      ...
      var camelizedKey = lodash.camelCase(key);
  ...
  function canonic(string) {
    ...
    var text = string + '';
    return lodash.deburr(text.trim().replace(/\s{2,}/g, ' ')).toLowerCase();
  }
  ...
  function blank(value) {
    switch (_typeof$1(value)) {
      ...
      default:
        ...
        return lodash.isEmpty(value) && !lodash.isNumber(value) || lodash.isNaN(value);
    }
  }
  ...
  function deleteBlanks(object) {
    var result = lodash.cloneDeep(object);

    lodash.forOwn(result, function (value, key) {
      if (lodash.isPlainObject(value) || lodash.isArray(value)) {
        result[key] = deleteBlanks(value);

        if (lodash.isArray(result[key])) {
          lodash.remove(result[key], blank);
        }
  ...
  function search(source, target) {
    ...
    return lodash.includes(_source, _target);
  }
  ...
  function deepSnakeizeKeys(object) {
    var snakeized = lodash.cloneDeep(object);
    ...
    lodash.forOwn(object, function (value, key) {
      ...
      var snakeizedKey = lodash.snakeCase(key);
  ...
  var lodashExt = lodash.assign({}, lodash, {
    ...
    kebabize: lodash.kebabCase,
    underscore: lodash.snakeCase,
    snakeize: lodash.snakeCase,
  ...
  function writableProp(instance, name) {
    ...
    if (lodashExt.includes(['constructor'], name) || lodashExt.startsWith(name, '$')) return false;
  ...
  function writablePropNames(instance) {
    var prototype = Object.getPrototypeOf(instance);
    var propNames = lodashExt.chain(Object.getOwnPropertyNames(instance)).
    concat(Object.getOwnPropertyNames(prototype)).
    uniq().
    value().
    sort();

    return lodashExt.filter(propNames, function (name) {return writableProp(instance, name);});
  }
    ...
    AttributableClass = /*#__PURE__*/function (_Class) {_inherits(AttributableClass, _Class);_createClass(AttributableClass, null, [{ key: "$enums",
        ...
        // TODO: define types and create "intelligent" setters? (with constraints)
          ...
          if (!this.hasOwnProperty('$$attrs')) {
            this.$$attrs = lodashExt.clone(this.attrs);
          }
        ...
        // TODO: define types and create "intelligent" setters? (with constraints)
          ...
          if (!this.hasOwnProperty('$$virtuals')) {
            this.$$virtuals = lodashExt.clone(this.virtuals);
          }
      ...
      function AttributableClass() {var _getPrototypeOf2;var _this;_classCallCheck(this, AttributableClass);for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {args[_key] = arguments[_key];}
        ...
        attrNameOrPath) {
          return lodashExt.get(this, attrNameOrPath);
        ...
        {for (var _len2 = arguments.length, attrNamesOrPathes = new Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {attrNamesOrPathes[_key2] = arguments[_key2];}
          return lodashExt.pick.apply(lodashExt, [this].concat(attrNamesOrPathes));
        } }, { key: "$present", value: function $present(

        attrNameOrPath) {
          return lodashExt.present(this.$get(attrNameOrPath));
        } }, { key: "$set", value: function $set(

        attrNameOrPath, value) {
          return lodashExt.set(this, attrNameOrPath, value);
  ...
  function hasOne(instance, relationName, config) {var _ref2 = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {},_ref2$get = _ref2.get,get = _ref2$get === void 0 ? null : _ref2$get,_ref2$set = _ref2.set,set = _ref2$set === void 0 ? null : _ref2$set;
    ...
    if (!set) {
      ...
      set = function set(value) {
        ...
        if (lodashExt.isArray(value)) throw new Error("can't assign an array to a hasOne relation");
  ...
  function hasMany(instance, relationName, config) {var _ref3 = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {},_ref3$get = _ref3.get,get = _ref3$get === void 0 ? null : _ref3$get,_ref3$set = _ref3.set,set = _ref3$set === void 0 ? null : _ref3$set;
    ...
    if (!set) {
      ...
      set = function set(values) {
        ...
        if (!lodashExt.isArray(values)) throw new Error("can't assign a non-array value to a hasMany relation");

        // TODO: should we assign values to fks? `${relation}_id`

        var modelInstances = lodashExt.map(values, function (value) {
    ...
    RelatableClass = /*#__PURE__*/function (_Class) {_inherits(RelatableClass, _Class);_createClass(RelatableClass, null, [{ key: "$relations",
        ...
        get: function get() {
          ...
          if (!this.hasOwnProperty('$$relations')) {
            this.$$relations = this.$$relations || lodashExt.reduce(this.relations, function (result, config, name) {
              result[name] = config;
              return result;
            }, {});
          }
  ...
  function presence(value, options, key, attrs) {
    var opts = lodashExt.merge({}, this.options, options);

    if (lodashExt.blank(value)) {
  ...
  Model = /*#__PURE__*/function (_mixin) {_inherits(Model, _mixin);_createClass(Model, null, [{ key: "$$model", get: function get()
      ...
      if (undefs) {
        ...
        var undefProps = lodashExt.reduce(propNames, function (undefProps, name) {
        ...
        sanitizedProps = lodashExt.merge(undefProps, sanitizedProps);
      }

      // set props, one-by-one, using setter method
      lodashExt.each(sanitizedProps, function (value, name) {
        _this[name] = value;
      });
  ...
  var _contents_errorsEnUS = { "en-US": { errors: { date: "must be a valid date", datetime: "must be a valid date", email: "is not a valid e-mail", equality: "is not equal to %{attribute}", exclusion: "%{value} is restricted", format: "is invalid", inclusion: "%{value} is not included in the list", length: "has incorrect length", numericality: "must be a valid number", presence: "can't be blank", url: "is not a valid URL", type: "has incorrect type" } } };var _contents_errorsPtBR = { "pt-BR": { errors: { date: "n\xE3o \xE9 uma data v\xE1lida", datetime: "n\xE3o \xE9 uma data v\xE1lida", email: "n\xE3o \xE9 um e-mail v\xE1lido", equality: "n\xE3o \xE9 igual a %{attribute}", exclusion: "%{value} n\xE3o \xE9 permitido", format: "n\xE3o \xE9 v\xE1lido", inclusion: "%{value} n\xE3o est\xE1 inclu\xEDdo na lista", length: "tem tamanho incorreto", numericality: "n\xE3o \xE9 um n\xFAmero v\xE1lido", presence: "n\xE3o pode ficar em branco", url: "n\xE3o \xE9 uma URL v\xE1lida", type: "n\xE3o \xE9 do tipo correto" } } };var contents$1 = { errorsEnUS: _contents_errorsEnUS, errorsPtBR: _contents_errorsPtBR };Object.freeze(contents$1);
